...
class DockerAgent:
    ...
    def _settings_fallback(self, key: str) -> str | None:
        mapping = {
            ...
            "AGENTMAIL_API_KEY": self.settings.agentmail_api_key,
            "AGENTMAIL_INBOX_ADDRESS": self.settings.agentmail_inbox_address,
            ...
            "CLAUDE_AUTH_MODE": self.settings.claude_auth_mode,
